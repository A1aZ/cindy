...
model supply your way: sign in to the official Cindy service (usage deducted
transparently), authorize the **Claude Code / Codex Coding Plan** you already
pay for — no duplicate bill — connect your own API keys, or use local models.
...
- **Skills** — teach a way of working once, reuse it forever, hand it to your team.
