/**
 * Compact accordion row for one personal IM channel.
 *
 * The row remains useful while collapsed: it shows transport status and the
 * channel's own Agent/model route. Only one row is expanded by ImBotSection,
 * so adding more channel types does not make the settings page grow linearly.
 */
  ...
  return (
    ...
    >
      <button
        ...
        onClick={onToggle}
        className={cn(
          'flex min-h-[76px] w-full select-none items-center gap-4 px-4 py-3 text-left',
