...
describe('buildConversationShareHtml 富内容导出', () => {
  ...
  it('限制原生 renderer 源尺寸，使用 SVG 主路径并安全保留已分享 PNG', () => {
