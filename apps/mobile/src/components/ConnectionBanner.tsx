...
export function useShowConnectionBanner(
  ...
  return recovery !== undefined || resolveConnectionBannerVisibility({
    offline,
...
export function ConnectionBanner({
  ...
  const visible = useDelayedConnectionNotice(cachedOnly || active, recovery === 'recovered', recovery === 'syncing');
